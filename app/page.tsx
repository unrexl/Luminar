              ...
              <div className="mt-8 flex items-center justify-center gap-6">
                ...
                >
                  <div className="flex items-center gap-4">
                    <img src="/puplic/rex-avatar.png" alt="Rex avatar" className="w-14 h-14 rounded-full object-cover" />
                ...
                >
                  <div className="flex items-center gap-4">
                    <img src="/puplic/fox-avatar.png" alt="Fox avatar" className="w-14 h-14 rounded-full object-cover" />
                    <div className="flex flex-col">
