  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-background/60 bg-background/80 border-b border-border">
        <div className="mx-auto flex h-14 sm:h-16 w-full max-w-7xl items-center justify-between px-2 sm:px-4 md:px-6">
          <div className="flex items-center gap-1.5 sm:gap-3 min-w-0 flex-shrink">
            <div className="flex-shrink-0">
              <MobileNav />
            </div>
            <img src="/luminar-logo.png" alt="Luminar Services Logo" className="h-5 sm:h-8 w-auto flex-shrink-0" />
            <span className="hidden xl:inline text-sm text-muted-foreground whitespace-nowrap">Luminar Services</span>
          </div>
          <nav className="flex items-center gap-1 sm:gap-2 md:gap-3 flex-shrink-0">
            <a
              ...
              className="hidden sm:inline-flex items-center justify-center px-2.5 sm:px-4 md:px-5 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-white bg-violet-600 hover:bg-violet-500 rounded-md sm:rounded-lg transition-all duration-300 shadow-sm hover:shadow-lg hover:shadow-violet-500/25 md:hover:scale-105 border border-violet-500/20 whitespace-nowrap"
            >
              Discord
            </a>
            <a
              href="/refund-policy"
              className="inline-flex items-center justify-center px-2 sm:px-3 md:px-5 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-white bg-gray-800/80 rounded-md sm:rounded-lg hover:bg-gray-700 transition-all duration-300 backdrop-blur-sm border border-gray-700/50 hover:border-gray-600 md:hover:scale-105 shadow-sm whitespace-nowrap"
            >
              <span className="hidden xs:inline sm:hidden md:inline">Refund Policy</span>
              <span className="xs:hidden sm:inline md:hidden">Policy</span>
      ...
      <section id="highlights" className="py-4 md:py-6">
        <div className="mx-auto max-w-7xl px-4">
          <div className="mb-10 flex flex-col items-center justify-center gap-4">
            <a
              href="/products"
              className="inline-flex items-center gap-2 bg-violet-600 hover:bg-violet-500 text-white font-semibold px-8 py-3 rounded-lg shadow-lg hover:shadow-xl hover:shadow-violet-500/25 transform hover:scale-105 transition-all duration-300 ease-out border border-violet-500/20"
            >
              See products
              <svg
